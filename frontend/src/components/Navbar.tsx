...
import { AppState, bc, fetchClient, FRONTEND_URL, loggedIn, resetSecret, clearSecretKeyFromServiceWorker } from "../utils";
...
export function setAppNavigation() {
    ...
    Median.sidebar.setItems({ items, enabled: true, persist: true });
    return <></>;
}
