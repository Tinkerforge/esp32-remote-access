...
diesel::joinable!(device_grouping_members -> chargers (charger_id));
diesel::joinable!(device_grouping_members -> device_groupings (grouping_id));
diesel::joinable!(device_groupings -> users (user_id));
